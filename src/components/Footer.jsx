...
<footer class="relative z-10 px-3 py-8 text-white transition-colors duration-200 bg-[#181a1d] border border-[#111214] dark:bg-gray-800 text-2 dark:text-gray-200">
    <div class="flex flex-col">
        ...
        <div class="flex flex-col mt-4 md:mt-0 md:flex-row">
            ...
            <div class="flex items-center justify-center flex-1 mt-4 border-gray-100 md:mt-0 md:border-r">
                <a class="hover:text-primary-gray-20" href="https://github.com/dev-maikeru/" target={'_blank'}>
                    <span class="sr-only">
                        View on GitHub
                    </span>
            ...
            <div class="flex flex-col items-center justify-center flex-1 mt-7 md:mt-0 md:items-start md:pl-5">
                ...
                <span class="mt-7 md:mt-1 flex gap-2">
                    <span>Created by</span> 
                    <a class="underline hover:text-primary-gray-20" href="https://www.linkedin.com/in/johnmichaelflores" target={'_blank'}>
                        Michael
                    </a>
                </span>
            </div>
